...
So **347** is just 13/360 _Hue_ increments, or degrees, different to zero! (Quite close, quite similar - 4% of the way around the colour wheel)
...
In _qualitative_ schemes, such as the [ColorBrewer Accent7](https://colorbrewer2.org/#type=qualitative&scheme=Accent&n=7) scheme hues vary across the spectrum and not in an order that we can detect.
...
Just to show what variation in _saturation_ looks like, here is the original scheme again in the _middle_ row.
