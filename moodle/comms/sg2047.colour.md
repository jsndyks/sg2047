...
Adding the three _lightness_ rings shows how a single hue can produce different colours as _lightness_ is varied, enabling us to differentiate the colours from classes 1 and 3.
