...
Here we add the numbers tha represent the various _hues_.
...
Let's think about a colour scheme and how hue varies within it - the [ColorBrewer YlOrRd](https://colorbrewer2.org/#type=sequential&scheme=YlOrRd&n=7) seven class scheme for example.
We can show the _hues_ used in the colours as angles and positions on the colour wheel.

<div style="align:center">
<img src="https://jsndyks.github.io/sg2047/img/sg2047.colorWheel.YlOrRd.7.png" style="width:300px; padding:0.5em; border:1px solid #e0e0e0"/>
</div>

So **347** is just 13 / 360 _Hue_ increments, or _degrees_, different to zero! (Quite close, quite similar - 4% of the way around the colour wheel)
...
Here the _hues_ are shown on a colour wheel with three rings that show three different levels of _lightness_.

<div style="align:center">
<img src="https://jsndyks.github.io/sg2047/img/sg2047.colorWheel.YlOrRd.7.rings.png" style="width:300px; padding:0.5em; border:1px solid #e0e0e0"/>
</div>
...
The **bottom row** shows the same _Hue_, and _Lightness_ as in the original, but keeps _Saturation_ constant at 98%. The only difference that I can detect is for class 6 where the dark hue seems to stand out. Look - the sequence from class 5 to class 7 does not seem constant.
...
<div style="align:center">
<img src="https://jsndyks.github.io/sg2047/img/sg2047.colorWheel.num.accent.7.png" style="width:300px; padding:0.5em; border:1px solid #e0e0e0"/>
</div>
...
Adding three rings that show variartions in _lightness_ for each hue shows how a single hue can produce different colours as _lightness_ is varied. This enables us to differentiate the colours from classes 1 and 3 used in [ColorBrewer Accent7](https://colorbrewer2.org/#type=qualitative&scheme=Accent&n=7).
