...
<img width="80%" style="margin-left:5%;margin-right:10%; border:1px #f0f0f0 solid; padding:2px" src="https://jsndyks.github.io/sg2047/img/tableau.map.editLocations.matching.png"/>
...
<img width="80%" style="margin-left:5%;margin-right:10%; border:1px #f0f0f0 solid; padding:2px" src="https://jsndyks.github.io/sg2047/img/tableau.map.editLocations.unrecognised.png"/>
...
<img width="80%" style="margin-left:5%;margin-right:10%; border:1px #f0f0f0 solid; padding:2px" src="https://jsndyks.github.io/sg2047/img/tableau.editLocations.countryRegion.png"/>

<img width="80%" style="margin-left:5%;margin-right:10%; border:1px #f0f0f0 solid; padding:2px" src="https://jsndyks.github.io/sg2047/img/tableau.editLocations.stateProvince.png"/>
...
<video width="400" height="300" controls>
  <source src="../mov/tableau.map.editLocations.mov" type="video/mp4"/>
</video>
</div>
...
But when can quickly see when the _Geography_ - _Location_ encoding has gone wrong and it makes irt difficult for us to make sense of our data!

And _Tableau_ gives us various options as to how we actually execute or implement this encoding. The one that man of us got initially when we followed the tutorial in class was a bad one: _**Houston**? - we have a problem!_
