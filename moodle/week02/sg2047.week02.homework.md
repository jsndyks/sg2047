...
There are **FIVE** tasks this week:
...
> _Can you develop DNA tables using the using these three components of colour that are **visual variables**?_
...
There is no need to watch this _yet_, but you should create an account.
