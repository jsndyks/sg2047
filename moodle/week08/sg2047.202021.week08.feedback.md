...
There seems to be a data channel that is not encoded in some of the graphics, where not all marks are countries.
Marks in some of the _scatter-plots_ that you selected represent continents and even the World.
