...
Some examples of issues that I identified in the marking ...
...
_Can we justify that **P** (poor) for **Guidance** (according to Roth) as there are only two categories in our _LIGHTNESS_ geography encoding?_
...
<div style="float:right">
<img src="https://jsndyks.github.io/sg2047/moodle/week08/img/ourWorldInData.compare.FAR.legend.png" width=100 style='padding-left:2em'/>
...
Interestingly the failure of the **PROPORTION** test is addressed by the interactive legend - look to the right. As you mouse-over the inaccurately **PROPORTION**ed, but thankfully **DETECT**able marks, their **PROPORTION**al *SIZE*s are shown in the legend.  
