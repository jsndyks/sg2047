...
You may want to save a worksheet by giving it a meaningful name and title, duplicating a copy. Remember to use <span class="menu">File</span>, <span class="menu">Save As...</span> to save a <code>TWBX</code> version of your _Tableau_ workbook before you move on.
