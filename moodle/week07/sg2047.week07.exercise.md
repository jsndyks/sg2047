...
<img width=600  src="http://staff.city.ac.uk/~jad7/sg2047/html/sg2047.201920.week07.slides.explore.v1.png"/>
</div>
...
<div class='imgBox' style='float:center; align:center'>
<img width=600  src="https://jsndyks.github.io/sg2047/img/sg2047.sg2047.07.tableau.census2011.selectedBoroughs.png"/>
</div>
...
<div class='imgR'>
<img width=480 height=375 src="http://staff.city.ac.uk/~jad7/pics/sg2047/sg2047.07.tableau.png"/>
</div>
...
As we move through and between ...

> <code>overview -> focus -> details -> record</code>

Using cycles and sequences of operations like ...
...
You may want to save images with the <span class="menu">Worksheet</span>, <span class="menu">Export</span> feature.

You may want to save a worksheeyt by giving it a meaningful name and title, duplicating a copy and using <span class="menu">File</span>, <span class="menu">Save As...</span> to save a version before you move on.
