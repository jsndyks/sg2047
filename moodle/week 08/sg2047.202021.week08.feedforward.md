...
- Find _your focus_ - a _Geographic Subset_ consisting of the LSOAs in a few Boroughs, just for you
...
Don't produce maps of themes that show population by mistake by using TOTALS and SUMS. There will always be more people of particular types where there are more people! Use RATIOs - these let us know the proportions of people with particular characteristics in populations of different sizes and help with comparisons:
...
- use annotations
- you should _not_ submit the Tableau workbook - so all assumptions, workings and decisions need to be described in the _commentary_
...
6. _COMMENTARY_ - text only - use the **Online Text** box
...
- better still - use **MS Teams** chat or come and find me in **A401E** during my _Office Hours_.
  ...
  Here's a [list of open-office sessions](https://moodle.city.ac.uk/mod/url/view.php?id=2381587). You can just call me on the **MS Teams** chat, unannounced during drop-in sessions. I am either helping students who arrived before you or waiting for students to show up!
