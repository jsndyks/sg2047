...
To be effective, the _layout_ use to _position_, _align_ and _relate_ the graphics will help with comparison tasks.
...
Maybe the _scales_ that we use differ as the data in each of our graphics have different _ranges_?
...
This resulted in lots of efforts to educate dashboard designers from people like [Stephen Few](http://www.stephen-few.com) at [Perceptual Edge](http://www.perceptualedge.com/examples.php).
